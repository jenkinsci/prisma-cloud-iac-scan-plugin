...
public class ScanResult {
  ...
  public void setHighSeverity(float highSeverity) { this.highSeverity = (int) highSeverity; }

  public float getMediumSeverity() {
    return mediumSeverity;
  }

  public void setMediumSeverity(float mediumSeverity) { this.mediumSeverity = (int) mediumSeverity; }

  public float getLowSeverity() {
    return lowSeverity;
  }

  public void setLowSeverity(float lowSeverity) { this.lowSeverity = (int) lowSeverity; }
  ...
  public void setHighPercentage(String highPercentage) { this.highPercentage = highPercentage; }

  public String getMediumPercentage() { return mediumPercentage; }

  public void setMediumPercentage(String mediumPercentage) { this.mediumPercentage = mediumPercentage; }
